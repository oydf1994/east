<template>
    <div class="header">
        ...
        <el-menu :default-active="onRoutes" class="el-menu-demo" mode="horizontal" @select="handleSelect" router
            ...
            <el-menu-item index="form">发布抽奖商品</el-menu-item>
            <el-menu-item index="table">已发布商品列表</el-menu-item>
            <el-menu-item index="list">已开奖商品列表</el-menu-item>
            <el-menu-item index="addUser">增加虚拟用户</el-menu-item>
        </el-menu>
    </div>
</template>
<script>
